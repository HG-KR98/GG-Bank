  ...
  <div class="container">
    <div class="container-out">
      <div class="container-int">
        <img
          src="@/assets/investmentArticle.png"
          alt="이미지가 없습니다..."
          class="title"
        />
        <!-- 검색창 -->
...
const paginatedArticles = computed(() => {
  ...
  console.log(store.investmentArticles);
  return store.investmentArticles.slice(start, end);
});

// 총 페이지 수 계산
const totalPages = computed(() => {
  return Math.ceil(store.investmentArticles.length / perPage.value);
});
